...
public class OtherFragment extends Fragment {
    ...
    private FirebaseRecyclerAdapter<Model, OtherFragment.OtherViewHolder> mPeopleRVAdapter;
    ...
    public View onCreateView(@NonNull LayoutInflater inflater, ViewGroup container,
        ...
        View other_view = inflater.inflate(R.layout.fragment_other, container, false);
        ...
        //Load ProgressBar
        mProgressBar = other_view.findViewById(R.id.progress_bar);
        mProgressBar.setVisibility(View.VISIBLE);

        //Initialize Database
        DatabaseReference mDatabase = FirebaseDatabase.getInstance().getReference().child("Other");
        mDatabase.keepSynced(true);

        RecyclerView mPeopleRV = other_view.findViewById(R.id.myRecycleView);
        mPeopleRV.setItemAnimator(new ScaleInAnimator());

        DatabaseReference personsRef = FirebaseDatabase.getInstance().getReference().child("Other");
        ...
        mPeopleRVAdapter = new FirebaseRecyclerAdapter<Model, OtherFragment.OtherViewHolder>(personsOptions) {
            @Override
            protected void onBindViewHolder(@NonNull OtherFragment.OtherViewHolder holder, int position, @NonNull Model model) {
            ...
            @Override
            public OtherFragment.OtherViewHolder onCreateViewHolder(ViewGroup parent, int viewType) {
                ...
                return new OtherFragment.OtherViewHolder(view);
            }
        };

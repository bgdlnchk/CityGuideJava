...
public class PharmacyFragment extends Fragment {
    ...
    private FirebaseRecyclerAdapter<Model, PharmacyFragment.PharmacyViewHolder> mPeopleRVAdapter;
    ...
    public View onCreateView(@NonNull LayoutInflater inflater, ViewGroup container,
        ...
        View pharmacy_view = inflater.inflate(R.layout.fragment_pharmacy, container, false);
        ...
        //Load ProgressBar
        mProgressBar = pharmacy_view.findViewById(R.id.progress_bar);
        mProgressBar.setVisibility(View.VISIBLE);

        //Initialize Database
        DatabaseReference mDatabase = FirebaseDatabase.getInstance().getReference().child("Pharmacy");
        mDatabase.keepSynced(true);

        RecyclerView mPeopleRV = pharmacy_view.findViewById(R.id.myRecycleView);
        mPeopleRV.setItemAnimator(new ScaleInAnimator());

        DatabaseReference personsRef = FirebaseDatabase.getInstance().getReference().child("Pharmacy");
        ...
        mPeopleRVAdapter = new FirebaseRecyclerAdapter<Model, PharmacyFragment.PharmacyViewHolder>(personsOptions) {
            @Override
            protected void onBindViewHolder(@NonNull PharmacyFragment.PharmacyViewHolder holder, int position, @NonNull Model model) {
            ...
            @Override
            public PharmacyFragment.PharmacyViewHolder onCreateViewHolder(ViewGroup parent, int viewType) {
                View view = LayoutInflater.from(parent.getContext())
                        .inflate(R.layout.row, parent, false);
                mProgressBar.setVisibility(View.GONE);
                return new PharmacyFragment.PharmacyViewHolder(view);
            }
        };

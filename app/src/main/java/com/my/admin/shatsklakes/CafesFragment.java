...
public class CafesFragment extends Fragment {
    ...
    private FirebaseRecyclerAdapter<Model, CafesFragment.CafesViewHolder> mPeopleRVAdapter;
    ...
    public View onCreateView(@NonNull LayoutInflater inflater, ViewGroup container,
        ...
        View cafes_view = inflater.inflate(R.layout.fragment_cafes, container, false);
        ...
        //Load ProgressBar
        mProgressBar = cafes_view.findViewById(R.id.progress_bar);
        mProgressBar.setVisibility(View.VISIBLE);

        //Initialize Database
        DatabaseReference mDatabase = FirebaseDatabase.getInstance().getReference().child("Cafes");
        mDatabase.keepSynced(true);

        RecyclerView mPeopleRV = cafes_view.findViewById(R.id.myRecycleView);
        mPeopleRV.setItemAnimator(new ScaleInAnimator());

        DatabaseReference personsRef = FirebaseDatabase.getInstance().getReference().child("Cafes");
        ...
        mPeopleRVAdapter = new FirebaseRecyclerAdapter<Model, CafesFragment.CafesViewHolder>(personsOptions) {
            @Override
            protected void onBindViewHolder(@NonNull CafesFragment.CafesViewHolder holder, int position, @NonNull Model model) {
            ...
            @Override
            public CafesFragment.CafesViewHolder onCreateViewHolder(ViewGroup parent, int viewType) {
                View view = LayoutInflater.from(parent.getContext())
                        .inflate(R.layout.row, parent, false);
                mProgressBar.setVisibility(View.GONE);
                return new CafesFragment.CafesViewHolder(view);
            }
        };
    ...
    public static class CafesViewHolder extends RecyclerView.ViewHolder{
        View mView;
        public CafesViewHolder(View itemView) {
            super(itemView);
            mView = itemView;
        }
